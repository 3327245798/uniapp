<template>
	<view class="header">
		...
		<!-- #endif -->
		<!-- <view class="navbar" :class="{'navbar-mini':true,'popup-menu':true}"> -->
			...
			<view class="navbar-right pointer">
			 ...
			 <view @click="showErrorLogs" class="menu-item debug pointer navbar-right-item-gap"> 
					<svg class="svg-icon">
				...
				<view class="" style="position: relative;">
					<!-- <view v-show="userInfo.nickname || userInfo.username || userInfo.mobile || userInfo.email" class="navbar-user" @click="togglePopupMenu"> -->
						<view class="navbar-user" @click="togglePopupMenu">
...
<style lang="scss">
	.header {
		...
		border-bottom: 1px solid #127890;
		//background-color: $top-window-bg-color;
		background-color:#255ee1;
