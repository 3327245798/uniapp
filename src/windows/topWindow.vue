				...
				<picker class="navbar-right-item-gap" mode="selector" :range="langs" range-key="text" @change="changeLanguage" :value="langIndex">
				 ...
				 <view class="" style="position: relative;">
					<view  class="navbar-user" @click="togglePopupMenu">
						...
						<view class="username ml-s"><text>{{aasdfd}}</text></view>
					...
					<view class="navbar-menu">
						<template >
							...
							<view class="menu-item hover-highlight">
								<text class="logout pointer" @click="logout">{{1234}}</text>
							</view>
						</template>
...
<style lang="scss">
	.header {
		...
		background-color: rgb(10, 208, 82);
